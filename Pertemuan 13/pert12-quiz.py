...
def urutdatabelanja(databelanjaan):
...
#urutkan data
data_belanja_urut = urutdatabelanja(databelanjaan)
...
for i in range(1,len(data_belanja_urut)) :
    print(data_belanja_urut[i][0], "\t\t", data_belanja_urut[i][1], "\t",data_belanja_urut[i][2], "\t",data_belanja_urut[i][3], "\t", data_belanja_urut[i][4], "\t")